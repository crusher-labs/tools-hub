# AGENTS.md - Text to Handwriting

Single-purpose static tool, built as a **world page**: composition book. Convert typed text into handwritten pages inside a marble composition book: five hands, blue, black or green ink, wide-ruled paper with a red margin, multi-page PNG output, no watermark. Part of the crusher-labs static tools line. Hosted on GitHub Pages at https://tools.muhammadhassaanjaved.com/text-to-handwriting/
