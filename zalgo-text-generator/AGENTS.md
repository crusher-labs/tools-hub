# AGENTS.md - Zalgo Text Generator

Single-purpose static tool, built as a **world page**: signal corruption. Turn any text into cursed Zalgo glitch text on a corrupted signal: a signal meter for intensity, above/through/below channels, a CRT output, one-click copy. Part of the crusher-labs static tools line. Hosted on GitHub Pages at https://tools.muhammadhassaanjaved.com/zalgo-text-generator/
