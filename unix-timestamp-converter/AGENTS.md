...
Single-purpose static tool, built as a **world page**: departures board. Convert Unix time both ways on a split-flap departures board: a ticking epoch row, local, UTC, ISO 8601 and relative rows that flip when the input changes; milliseconds detected. Part of the crusher-labs static tools line. Hosted on GitHub Pages at https://tools.muhammadhassaanjaved.com/unix-timestamp-converter/
