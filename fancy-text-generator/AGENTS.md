# AGENTS.md - Fancy Text Generator

Single-purpose static tool, built as a **world page**: specimen sheet. Turn plain text into 27 Unicode font styles on a type specimen sheet, each with a size waterfall and character set; copy any style to paste into Instagram, TikTok, Discord or X. Part of the crusher-labs static tools line. Hosted on GitHub Pages at https://tools.muhammadhassaanjaved.com/fancy-text-generator/
