...
Single-purpose static tool, built as a **world page**: fan deck. Generate harmonies as a paint-store fan deck: named, coded chips with five shades each, fanned from a rivet; tap a shade to copy, copy the whole deck as CSS variables. Part of the crusher-labs static tools line. Hosted on GitHub Pages at https://tools.muhammadhassaanjaved.com/color-palette-generator/
