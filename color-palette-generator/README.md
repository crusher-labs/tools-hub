...
Generate harmonies as a paint-store fan deck: named, coded chips with five shades each, fanned from a rivet; tap a shade to copy, copy the whole deck as CSS variables.

Live: <https://tools.muhammadhassaanjaved.com/color-palette-generator/>
