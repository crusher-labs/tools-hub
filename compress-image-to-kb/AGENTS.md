# AGENTS.md - Compress Image to KB

Single-purpose static tool, built as a **world page**: darkroom gauge. Compress JPG, PNG or WebP images to an exact target size in a darkroom: an amber gauge that fills toward the target, a developing tray for the files, prints on a film strip; plus per-size landing pages generated by scripts/gen-variants.mjs. Part of the crusher-labs static tools line. Hosted on GitHub Pages at https://tools.muhammadhassaanjaved.com/compress-image-to-kb/
