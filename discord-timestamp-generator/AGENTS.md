# AGENTS.md - Discord Timestamp Generator

Single-purpose static tool, built as a **world page**: newsroom clock wall. Generate Discord timestamps on a wall of six city clocks that turn to the moment you pick, with all 7 formats, live previews and one-click copy. Part of the crusher-labs static tools line. Hosted on GitHub Pages at https://tools.muhammadhassaanjaved.com/discord-timestamp-generator/
